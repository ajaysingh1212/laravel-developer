        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.websetting.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.websettings.update", [$websetting->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $websetting->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group {{ $errors->has('meta_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $websetting->meta_title) }}">
                        ...
                        <div class="form-group {{ $errors->has('meta_discription') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="meta_discription" id="meta_discription" value="{{ old('meta_discription', $websetting->meta_discription) }}">
                        ...
                        <div class="form-group {{ $errors->has('mera_keyword') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="mera_keyword" id="mera_keyword">{!! old('mera_keyword', $websetting->mera_keyword) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('sitemap') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="sitemap" id="sitemap">{!! old('sitemap', $websetting->sitemap) !!}</textarea>
