                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.headers.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('meta_dis') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="meta_dis" id="meta_dis" value="{{ old('meta_dis', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('footer_about') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="footer_about" id="footer_about" value="{{ old('footer_about', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('insta') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="insta" id="insta" value="{{ old('insta', '') }}">
                            @if($errors->has('insta'))
                        ...
                        <div class="form-group {{ $errors->has('linkdin') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="linkdin" id="linkdin" value="{{ old('linkdin', '') }}">
