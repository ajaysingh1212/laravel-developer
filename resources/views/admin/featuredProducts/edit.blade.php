                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.featured-products.update", [$featuredProduct->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('product_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="product_name" id="product_name" value="{{ old('product_name', $featuredProduct->product_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('product_title') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="product_title" id="product_title" value="{{ old('product_title', $featuredProduct->product_title) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('product_discription') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="product_discription" id="product_discription" value="{{ old('product_discription', $featuredProduct->product_discription) }}" required>
