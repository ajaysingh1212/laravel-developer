                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('addhar_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="addhar_number" id="addhar_number" value="{{ old('addhar_number', $user->addhar_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('pan_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pan_number" id="pan_number" value="{{ old('pan_number', $user->pan_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('pincode') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pincode" id="pincode" value="{{ old('pincode', $user->pincode) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('present_address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="present_address" id="present_address">{!! old('present_address', $user->present_address) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('permanent_address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="permanent_address" id="permanent_address">{!! old('permanent_address', $user->permanent_address) !!}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('shop_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="shop_name" id="shop_name" value="{{ old('shop_name', $user->shop_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('shop_gst_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="shop_gst_number" id="shop_gst_number" value="{{ old('shop_gst_number', $user->shop_gst_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('shop_pan_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="shop_pan_number" id="shop_pan_number" value="{{ old('shop_pan_number', $user->shop_pan_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('shop_state') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="shop_state" id="shop_state" value="{{ old('shop_state', $user->shop_state) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('shop_city') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="shop_city" id="shop_city" value="{{ old('shop_city', $user->shop_city) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('shop_pincode') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="shop_pincode" id="shop_pincode" value="{{ old('shop_pincode', $user->shop_pincode) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('shop_address') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="shop_address" id="shop_address">{!! old('shop_address', $user->shop_address) !!}</textarea>
