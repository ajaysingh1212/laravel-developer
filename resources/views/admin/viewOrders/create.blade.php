        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.viewOrder.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.view-orders.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('order_bies') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="order_bies[]" id="order_bies" multiple required>
                                @foreach($order_bies as $id => $order_by)
                                    <option value="{{ $id }}" {{ in_array($id, old('order_bies', [])) ? 'selected' : '' }}>{{ $order_by }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('order_related_by') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="order_related_by_id" id="order_related_by_id">
                                @foreach($order_related_bies as $id => $entry)
                                    <option value="{{ $id }}" {{ old('order_related_by_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('total_price') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="total_price" id="total_price" value="{{ old('total_price', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('delevery_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="delevery_date" id="delevery_date" value="{{ old('delevery_date') }}">
                        ...
                        <div class="form-group {{ $errors->has('order_status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="order_status" id="order_status" required>
                                ...
                                @foreach(App\Models\ViewOrder::ORDER_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('order_status', 'Update Order Status') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('order_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="order_number" id="order_number" value="{{ old('order_number', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('user_email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="user_email" id="user_email" value="{{ old('user_email', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('user_phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="user_phone" id="user_phone" value="{{ old('user_phone', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('user_state') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="user_state" id="user_state" value="{{ old('user_state', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('user_city') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="user_city" id="user_city" value="{{ old('user_city', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('user_pincode') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="user_pincode" id="user_pincode" value="{{ old('user_pincode', '') }}" required>
