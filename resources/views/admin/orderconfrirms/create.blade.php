        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.orderconfrirm.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.orderconfrirms.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('order_no') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="order_no" id="order_no" value="{{ old('order_no', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('charge') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="charge" id="charge" value="{{ old('charge', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('total_amount') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_amount" id="total_amount" value="{{ old('total_amount', '') }}" step="1" required>
